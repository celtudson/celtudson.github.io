...
var game_Dice = function() {
	this.cut2 = { startX : -1, x : -1, fading : 0};
	this.cut1 = { startX : -1, x : -1, fading : 0};
...
game_Dice.prototype = {
	...
	,initBattle: function(heroFirst,b1,b2) {
		...
		if(heroFirst == false) {
			...
			haxe_Log.trace(line,{ fileName : "game/Dice.hx", lineNumber : 60, className : "game.Dice", methodName : "initBattle"});
			this.battleLog.push(line);
			this.battleLogColor.push(0);
			this.rotate(true,Math.PI);
			this.roll();
		} else {
			this.nextTurn = true;
			var line1 = "Вы напали на " + game_data_Races.getName(b2.race);
			haxe_Log.trace(line1,{ fileName : "game/Dice.hx", lineNumber : 68, className : "game.Dice", methodName : "initBattle"});
	...
	,roll: function() {
		if(this.lastDiceContr) {
			if(this.autoRoll == false) {
				...
				this.rotate(null,2 * Math.PI);
			} else {
				this.rotate(null,this.lastDaggerDir * Math.PI);
			}
		} else {
			this.rotate(null,Math.PI);
		}
		...
		case -5:
			...
			traceString += line2;
			haxe_Log.trace(traceString,{ fileName : "game/Dice.hx", lineNumber : 152, className : "game.Dice", methodName : "roll"});
		...
		if(resultDice == 0) {
			...
			damage = (multi * atk.atk * 100 | 0) / 100;
		...
		var d1 = 0;
		haxe_Log.trace(traceString,{ fileName : "game/Dice.hx", lineNumber : 191, className : "game.Dice", methodName : "roll"});
	}
	,render: function(g,x,y) {
		...
		if(this.draw2_dice > 0) {
			g.drawSubImage(this.imgDice,x + 20,y + 31,11 * (this.draw2_dice - 1),0,11,11);
			g.drawSubImage(this.imgDice,x + 20 + 17,y + 31,11 * (this.draw2_dice2 - 1),0,11,11);
		}
		var _this = g.transformations[g.transformations.length - 1];
		var m__00 = Math.cos(this.daggerAngle);
		var m__10 = Math.sin(this.daggerAngle);
		var m__20 = x + 34;
		var m__01 = -Math.sin(this.daggerAngle);
		var m__11 = Math.cos(this.daggerAngle);
		var m__21 = y + 21;
		var m__02 = 0;
		var m__12 = 0;
		var m__22 = 1;
	...
	,setCut: function(id) {
		if(id == 1) {
			this.cut1 = { startX : 50, x : 50, fading : 60};
		} else {
			this.cut2 = { startX : 50, x : 50, fading : 60};
		}
	}
	,getName: function() {
		if(this.nextTurn) {
...
game_Game.prototype = $extend(khm_Screen.prototype,{
	...
	,onRender: function(canvas) {
		...
		g.set_fontSize(18);
		this.dice.render(g,0,khm_Screen.h - 42);
		g.end();
	}
	,onUpdate: function() {
		if(this.keys.h[32]) {
...
kha_Shaders.init = function() {
	...
	kha_Shaders.painter_image_frag = new kha_graphics4_FragmentShader(blobs1,["painter-image.frag.essl","painter-image-webgl2.frag.essl","painter-image-relaxed.frag.essl"]);
	var blobs2 = [];
	...
	kha_Shaders.painter_image_vert = new kha_graphics4_VertexShader(blobs2,["painter-image.vert.essl","painter-image-webgl2.vert.essl","painter-image-relaxed.vert.essl"]);
	var blobs3 = [];
	...
	kha_Shaders.painter_colored_vert = new kha_graphics4_VertexShader(blobs3,["painter-colored.vert.essl","painter-colored-webgl2.vert.essl","painter-colored-relaxed.vert.essl"]);
	var blobs4 = [];
