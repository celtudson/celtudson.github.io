...
game_Board.reset = function() {
	...
	game_Board.sides[1] = [];
	game_Board.sides[1][0] = { type : 0, value : 1};
	game_Board.sides[1][1] = { type : 0, value : 2};
	game_Board.sides[1][2] = { type : 0, value : 3};
	game_Board.sides[1][3] = { type : 0, value : 4};
	game_Board.sides[2] = [];
	game_Board.sides[2][0] = { type : 0, value : 5};
	game_Board.sides[2][1] = { type : 0, value : 6};
	game_Board.sides[2][2] = { type : 0, value : 7};
	game_Board.sides[2][3] = { type : 0, value : 8};
	game_Board.sides[3] = [];
	game_Board.sides[3][0] = { type : 0, value : 9};
	game_Board.sides[3][1] = { type : 0, value : 10};
	game_Board.sides[3][2] = { type : 0, value : 11};
	game_Board.sides[3][3] = { type : 0, value : 12};
	game_Board.sides[4] = [];
	game_Board.sides[4][0] = { type : 0, value : 13};
	game_Board.sides[4][1] = { type : 0, value : 14};
	game_Board.sides[4][2] = { type : 0, value : 15};
	game_Board.sides[4][3] = { type : 0, value : 16};
	game_Board.sides[5] = [];
	game_Board.sides[5][0] = { type : 0, value : 17};
	game_Board.sides[5][1] = { type : 0, value : 18};
	game_Board.sides[5][2] = { type : 0, value : 19};
	game_Board.sides[5][3] = { type : 0, value : 20};
	game_Board.sides[6] = [];
	game_Board.sides[6][0] = { type : 0, value : 21};
	game_Board.sides[6][1] = { type : 0, value : 22};
	game_Board.sides[6][2] = { type : 0, value : 23};
	game_Board.sides[6][3] = { type : 0, value : 24};
...
game_Board.doTurn = function() {
	game_Board.curSideEntities[game_Board.sectionN].value = 0;
...
game_Board.onRender = function(g) {
	...
	g.set_color(-1778384896);
	g.fillRect(0,0,360,200);
	g.set_color(-1);
	g.drawString("" + game_Board.curSideEntities[0].value,(game_Board.diceX + 17) * game_Game.scaleN,(game_Board.diceY - 6) * game_Game.scaleN);
	g.drawString("" + game_Board.curSideEntities[1].value,(game_Board.diceX + 63) * game_Game.scaleN,(game_Board.diceY - 6) * game_Game.scaleN);
	g.drawString("" + game_Board.curSideEntities[2].value,(game_Board.diceX + 65) * game_Game.scaleN,(game_Board.diceY + 10) * game_Game.scaleN);
	g.drawString("" + game_Board.curSideEntities[3].value,(game_Board.diceX + 15) * game_Game.scaleN,(game_Board.diceY + 10) * game_Game.scaleN);
	var n = 1;
	var _g1 = 0;
	while(_g1 < 3) {
		var iy = _g1++;
		g.drawString("" + game_Board.sides[n][0].value,0,iy * 64);
		g.drawString("" + game_Board.sides[n][1].value,24,iy * 64);
		g.drawString("" + game_Board.sides[n][2].value,0,iy * 64 + 16);
		g.drawString("" + game_Board.sides[n][3].value,24,iy * 64 + 16);
		++n;
		g.drawString("" + game_Board.sides[n][0].value,64,iy * 64);
		g.drawString("" + game_Board.sides[n][1].value,88,iy * 64);
		g.drawString("" + game_Board.sides[n][2].value,64,iy * 64 + 16);
		g.drawString("" + game_Board.sides[n][3].value,88,iy * 64 + 16);
		++n;
	}
	g.drawString("dir: " + game_Board.curSideDir,120,0);
	g.drawString("top: " + game_Board.top,120,15);
	g.drawString("front: " + game_Board.front,120,30);
	g.drawString("left: " + game_Board.left,120,45);
	g.drawString("back: " + game_Board.back,120,60);
	g.drawString("right: " + game_Board.right,120,75);
	g.drawString("bottom: " + game_Board.bottom,120,90);
};
...
var kha__$Assets_ImageList = function() {
	this.names = ["ground","hero1","sel0","sel1","sss"];
	this.sssDescription = { name : "sss", original_height : 16, original_width : 16, files : ["sss.png"], type : "image"};
	this.sssName = "sss";
	this.sss = null;
...
kha__$Assets_ImageList.prototype = {
	...
	,sssName: null
	,sssDescription: null
	,sssLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "sssLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadImage("sss",function(image) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "sssLoad"});
	}
	,sssUnload: function() {
		this.sss.unload();
		this.sss = null;
