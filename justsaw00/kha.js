...
var draw_Sprite = function(img,isInverted) {
	this.img = img;
...
draw_Sprite.prototype = {
	...
	,onRender: function(g,x,y) {
		...
		if(this.isInverted == false) {
			draw_Atlas.drawSubImage(g,this.img,x,y - this.frameH,this.frameW * this.frameI,0,this.frameW,this.frameH);
		} else {
			draw_Atlas.drawScaledSubImage(g,this.img,x,y - this.frameH,-1,1,this.frameW * this.frameI,0,this.frameW,this.frameH);
		}
	}
