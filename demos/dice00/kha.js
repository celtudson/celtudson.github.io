...
game_Battle.prototype = {
	...
	,render: function(g) {
		...
		g.drawString("" + this.being1OldHp,0,0);
		g.drawString("" + this.being2OldHp,0,20);
...
game_Dice.prototype = {
	...
	,render: function(g,x,y,gameScale) {
		...
		if(this.draw1_dice > 0) {
			g.drawSubImage(this.imgDice,dice1_x,dices1_y,11 * (this.draw1_dice - 1),0,11,11);
			g.drawSubImage(this.imgDice,dice2_x,dices1_y,11 * (this.draw1_dice2 - 1),0,11,11);
		}
		if(this.draw2_dice > 0) {
			g.drawSubImage(this.imgDice,dice1_x,dices2_y,11 * (this.draw2_dice - 1),0,11,11);
			g.drawSubImage(this.imgDice,dice2_x,dices2_y,11 * (this.draw2_dice2 - 1),0,11,11);
		}
...
var kha__$Assets_ImageList = function() {
	...
	this.diceName = "dice";
	this.dice = null;
	this.daggerDescription = { name : "dagger", original_height : 18, original_width : 11, files : ["dagger.png"], type : "image"};
