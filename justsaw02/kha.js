...
Main.__name__ = true;
Main.main = function() {
	kha_System.start(new kha_SystemOptions("JustSaw",800,480,null,null),function(_) {
...
draw_Sprite.prototype = {
	...
	,onRender: function(g,x,y) {
		...
		if(this.directionX == 1) {
			...
			this.drawX = x - this.frameW;
		}
		g.drawString("" + this.allTicks,this.drawX,y);
	}
...
game_Game.prototype = $extend(khm_Screen.prototype,{
	...
	,onRender: function(canvas) {
		...
		g.drawString("" + this.energyAxe,120,13);
		this.ui.begin(g);
...
var game_units_Being = function(g,type,x,direction,enemyTeam) {
	if(direction == null) {
		direction = 1;
	}
	...
	case 0:
		this.isTurret = true;
		this.idleSprite = new draw_Sprite("hermit",direction);
...
game_units_Being.prototype = {
	...
	,setRects: function(bx,bw,ax,aw) {
		if(this.direction == 1) {
			...
			this.atkRect = { x : ax, w : aw};
		} else {
			this.bodyRect = { x : -bx - bw, w : bw};
			this.atkRect = { x : -ax - aw, w : aw};
		}
	}
	,isCollideWith: function(x2,b2) {
		if(this.x + this.bodyRect.x + this.bodyRect.w >= x2 + b2.x && this.x + this.bodyRect.x <= x2 + b2.x + b2.w) {
			return true;
		}
		return false;
	}
	,onUpdate: function() {
		...
		if(this.isAttack == false) {
			...
			if(this.lastIsAttack) {
				this.lastIsAttack = false;
				this.idleSprite.setFrame(0);
			}
			this.x += this.direction * this.params.speed;
		} else {
			if(this.atkSprite.onUpdate() == this.params.periodicAttack) {
				this.timeToAttack = true;
			}
			if(this.lastIsAttack == false) {
				this.lastIsAttack = true;
				this.atkSprite.setFrame(0);
			}
		}
	}
	,onRender: function(g) {
		...
		var str = (this.params.hp * 10 | 0) / 10 + ":" + (this.params.damage * 100 | 0) / 100;
		g.drawString(str,drawX,this.y - 50);
	}
	,hurt: function(delta) {
...
var kha__$Assets_ImageList = function() {
	this.names = ["hammer","hammerAtk","hermit","saw"];
	this.sawDescription = { name : "saw", original_height : 17, original_width : 96, files : ["saw.png"], type : "image"};
	this.sawName = "saw";
	this.saw = null;
	this.hermitDescription = { name : "hermit", original_height : 20, original_width : 23, files : ["hermit.png"], type : "image"};
...
kha__$Assets_ImageList.prototype = {
	...
	,hammer: null
	,hammerName: null
	,hammerDescription: null
	,hammerLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "hammerLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadImage("hammer",function(image) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "hammerLoad"});
	}
	,hammerUnload: function() {
		this.hammer.unload();
		this.hammer = null;
	}
	,hammerAtk: null
	,hammerAtkName: null
	,hammerAtkDescription: null
	,hammerAtkLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "hammerAtkLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadImage("hammerAtk",function(image) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "hammerAtkLoad"});
	}
	...
	,sawName: null
	,sawDescription: null
	,sawLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "sawLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadImage("saw",function(image) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "sawLoad"});
	}
	,sawUnload: function() {
		this.saw.unload();
		this.saw = null;
